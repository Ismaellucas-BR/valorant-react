    ...
    <section>
      <div className="relative ">
        <video
          ...
          loop
          playsInline
          className="w-full h-[580px] object-cover z-0"
          style={{ display: "flex" }}>
          <source
        ...
        <div className="absolute flex flex-col items-center text-center w-full top-50 z-30 gap-5">
          <img
            ...
            className="w-[15rem] h-[2.9rem]"
          />
          <h1 className="text-[1.6rem] font-tungsten uppercase leading-7">
            VALORANT – Jogo de tiro tático 5x5 <br></br> estrelando Agentes com
            habilidades únicas
          </h1>
          <button
