    ...
    <section className="w-full">
      <div className="relative ">
        <video
          ...
          loop
          playsInline
          className="w-full h-[580px] object-cover z-0  md:h-[26rem] xl:h-[29rem]"
          style={{ display: "flex" }}>
          <source
        ...
        <div className="absolute flex flex-col items-center text-center w-full top-50 z-30 gap-5 md:top-24">
          <img
